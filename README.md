This is a project to build a React-based website that implements the board game of Battleship. You can see an example at https://battleship-online.azurewebsites.net/.
